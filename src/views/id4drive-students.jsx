...
const STUDENTS = [
  { id:"s1",  name:"Марія Коваль",   phone:"+380671234567", type:"school",  tsc:"ТСЦ 8041",      catId:"cat-std", hours:12, totalPaid:7200,  noshow:0, rating:4.8, blocked:false, active:true,
    ...
    bookings:[
      {date:"2026-05-20",time:"10:00",svc:"Автошкола 1г",status:"confirmed",price:600},
      {date:"2026-05-13",time:"12:00",svc:"Автошкола 1г",status:"confirmed",price:600},
      {date:"2026-05-06",time:"10:00",svc:"Автошкола 2г",status:"confirmed",price:1100},
    ]
  },
  { id:"s2",  name:"Іван Петренко",  phone:"+380509876543", type:"private", tsc:"",               catId:"cat-vip", hours:5,  totalPaid:3500,  noshow:1, rating:4.2, blocked:false, active:true,
    lastLesson:"2026-05-21", address:"Київ, вул. Лесі Українки 10", born:"1990-07-22",
    passport:"ВВ654321", license:"АА-0001-ВВ", notes:"VIP клієнт. Зручний час — вечір.", tags:["VIP","вечірній"],
    bookings:[
      {date:"2026-05-21",time:"17:00",svc:"Приватний 1г",status:"confirmed",price:700},
  ...
  { id:"s3",  name:"Олена Мороз",    phone:"+380631112233", type:"school",  tsc:"ТСЦ 8042",     catId:"cat-std", hours:38, totalPaid:22800, noshow:0, rating:5.0, blocked:false, active:true,
    ...
    bookings:[
      {date:"2026-05-19",time:"09:00",svc:"Автошкола 2г",status:"confirmed",price:1100},
    ]
  },
  { id:"s4",  name:"Дмитро Сало",    phone:"+380961234567", type:"private", tsc:"",               catId:"cat-vip", hours:9,  totalPaid:6300,  noshow:0, rating:4.7, blocked:false, active:true,
    lastLesson:"2026-05-18", address:"Бровари, вул. Центральна 1", born:"1985-01-30",
    passport:"ДД777888", license:"АВ-1234-СД", notes:"", tags:["VIP","пунктуальний"],
    bookings:[
  ...
  { id:"s5",  name:"Тетяна Кравець", phone:"+380731234567", type:"school",  tsc:"ТСЦ 8041",      catId:"cat-std", hours:40, totalPaid:24000, noshow:1, rating:4.2, blocked:false, active:true,
    ...
    bookings:[
      {date:"2026-05-15",time:"11:00",svc:"Автошкола 1г",status:"noshow",   price:600},
    ]
  },
  { id:"s6",  name:"Богдан Сірий",   phone:"+380501010101", type:"private", tsc:"",               catId:"cat-new", hours:2,  totalPaid:1400,  noshow:3, rating:2.1, blocked:true,  active:false,
    lastLesson:"2026-04-01", address:"", born:"2003-09-09",
    passport:"", license:"", notes:"Систематично не з'являється. Заблоковано.", tags:["проблемний"],
    bookings:[
      {date:"2026-04-01",time:"10:00",svc:"Приватний 1г",status:"noshow",price:700},
    ]
  },
  { id:"s7",  name:"Юлія Денисюк",   phone:"+380935023739", type:"private", tsc:"",               catId:"cat-new", hours:3,  totalPaid:2100,  noshow:0, rating:4.5, blocked:false, active:true,
    lastLesson:"2026-05-22", address:"Київ, вул. Хрещатик 22", born:"2001-02-14",
    passport:"ЖЖ444555", license:"", notes:"Новий учень, добрий старт.", tags:["новачок"],
    bookings:[
      {date:"2026-05-22",time:"15:00",svc:"Приватний 2г",status:"pending",price:1300},
    ]
  },
];
